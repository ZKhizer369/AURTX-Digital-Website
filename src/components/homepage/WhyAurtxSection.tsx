...
export function WhyAurtxSection() {
  return <section style={{ '--ribbed-background': 'url(' + picture('ribbed-background.png') + ')' } as CSSProperties} className="why-section px-6 pt-12 pb-16 [@media(max-width:639px)]:px-5 [@media(max-width:639px)]:pt-8 [@media(max-width:639px)]:pb-12 [&_.section-heading]:max-w-350 [&_h2]:font-bold!" id="why-aurtx" aria-labelledby="why-title">
    <SectionHeading>
