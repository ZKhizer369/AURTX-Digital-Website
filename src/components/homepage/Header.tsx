...
export function Header() {
  ...
  return <header className="site-header z-20 mx-auto rounded-3xl bg-[#F5F8F7] flex h-20 max-w-380 items-center justify-between gap-6 px-6 py-3 text-[#0b6b53] [&>a]:shrink-0 [&>a_img]:h-auto [&>a_img]:w-16.25 before:absolute before:inset-0 before:left-1/2 before:-z-10 before:w-screen before:-translate-x-1/2 before:bg-[#f5f8f7] before:content-[''] [@media(max-width:1099px)]:gap-4 [@media(max-width:639px)]:h-18 [@media(max-width:639px)]:px-5 [@media(max-width:639px)]:[&>a_img]:w-14.5">
    ...
    <nav ref={drawer} id="main-navigation" aria-label="Main navigation" className={`navigation flex items-center gap-12 font-[Lato,sans-serif] font-semibold text-lg [&>a]:relative [&>a]:w-fit [&>a]:py-2 [&>a]:after:absolute [&>a]:after:bottom-0 [&>a]:after:left-0 [&>a]:after:h-0.5 [&>a]:after:w-full [&>a]:after:origin-left [&>a]:after:scale-x-0 [&>a]:after:bg-current [&>a]:after:transition-transform [&>a]:after:duration-400 [&>a]:after:content-[''] [&>a:hover]:after:scale-x-100 [&>a:focus-visible]:after:scale-x-100 [&>a[aria-current]]:after:scale-x-100 [@media(max-width:1099px)]:fixed [@media(max-width:1099px)]:inset-y-0 [@media(max-width:1099px)]:left-0 [@media(max-width:1099px)]:right-auto [@media(max-width:1099px)]:z-31 [@media(max-width:1099px)]:m-0 [@media(max-width:1099px)]:h-dvh [@media(max-width:1099px)]:w-[75vw] [@media(max-width:1099px)]:flex-col [@media(max-width:1099px)]:items-start [@media(max-width:1099px)]:gap-5 [@media(max-width:1099px)]:overflow-y-auto [@media(max-width:1099px)]:rounded-none [@media(max-width:1099px)]:bg-[#f5f8f7] [@media(max-width:1099px)]:px-7 [@media(max-width:1099px)]:pt-21 [@media(max-width:1099px)]:pb-8 [@media(max-width:1099px)]:text-lg [@media(max-width:1099px)]:shadow-[10px_0_40px_#0002] [@media(max-width:1099px)]:transform-[translateX(-105%)] [@media(max-width:1099px)]:invisible [@media(max-width:1099px)]:transition-[transform,visibility] [@media(max-width:1099px)]:duration-400 [@media(max-width:1099px)]:ease-[ease] [@media(max-width:1099px)]:[&.is-open]:transform-[translateX(0)] [@media(max-width:1099px)]:[&.is-open]:visible [@media(max-width:1099px)]:[&.is-closing]:transform-[translateX(100vw)] [@media(max-width:1099px)]:[&.is-closing]:invisible${menuOpen ? ' is-open' : ''}${menuClosing ? ' is-closing' : ''}`}>
