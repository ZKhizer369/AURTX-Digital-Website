...
export function HeroSection() {
  return <div className="hero-wrap relative pb-13.5">
    <section style={{ '--ribbed-background': 'url(' + picture('ribbed-background.png') + ')' } as CSSProperties} className="hero relative pt-5 px-5 bg-[#080e0d] bg-(image:--ribbed-background) bg-cover bg-center bg-no-repeat text-white [@media(max-width:639px)]:pb-8.75" aria-labelledby="hero-title">
      <Header />
