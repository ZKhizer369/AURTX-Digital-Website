...
export function ProblemsSection() {
  return <section id="problems" aria-labelledby="problems-title" className="mx-auto max-w-[1300px] px-5 py-10 sm:px-6 sm:py-16">
    ...
    <ol className="mt-10 grid gap-6 min-[640px]:grid-cols-2 min-[1100px]:grid-cols-3">
      {problems.map(([title, description], index) => <li key={title} className="group relative isolate flex flex-col gap-4 overflow-hidden rounded-[20px] border border-[#dde9e5] bg-[#f2f2f2] p-6 text-black transition-colors duration-200 hover:bg-black hover:text-white sm:p-7">
