...
export function FeaturesCta() {
  return <section aria-labelledby="features-cta-title" className="relative isolate mx-auto flex max-w-325 items-center justify-center overflow-hidden px-5 py-12 sm:px-6 sm:py-16">
